...
export const auth = betterAuth({
  ...
  emailAndPassword: {
    enabled: true,
    autoSignIn: false,
    requireEmailVerification: true  // Changed to false for easier testing
  },
  emailVerification: {
    ...
    sendVerificationEmail: async ({ user, url, token }, request) => {
      ...
      try {
        ...
        const info = await transporter.sendMail({
          from: '"Enamul Haque" <enamulbokshi@gmail.com>',
          to: user.email,
          subject: "Complete your registration",
          text: `Hello bara ${user.name}`,
          html: `
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>
        Regards,<br />
        <strong>Enamul Haque</strong>
      </p>
    </div>

    <div class="footer">
      © 2025 Enamul Haque. All rights reserved.
    </div>
  </div>
</body>
</html>
